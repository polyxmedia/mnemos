...
type saveArgs struct {
	...
	TrustTier   string   `json:"trust_tier,omitempty" jsonschema:"raw|curated|skill — defaults to curated for user saves; tool/agent_inference/import content is quarantined to raw automatically regardless of this value"`
