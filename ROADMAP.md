...
Two more architectural moves from a second deep-research pass after watching the v0.5.x cycle. These compose with the existing trio rather than competing with it. Bet 4 is post-hoc accountability for what shipped, Bet 5 is forward-looking enforcement so the wrong code can't ship in the first place.
